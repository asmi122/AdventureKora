            ...
            <div class="col-md-6">
              <div class="d-flex justify-content-md-end justify-content-between">
                <ul class="social-custom list-inline">
                  ...
                  <li class="list-inline-item"><a href="#"><i class="fab fa-tripadvisor"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <a class="navbar-brand" href="#"><img src="images/kora.png"></a>
		  <!-- Links -->
              <ul class="navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link" href="#">Tailor Made</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"> Plan A Trip </a>
					<div class="dropdown-menu">
						<a href="#">Book Now</a>
